...
export default function GopayPayment({ navigation, route }) {
      ...
      <ScrollView>
        <View style={{ padding: 10 }}>
          <View>
            ...
            <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 15, }}>Total Rp {new Intl.NumberFormat().format(route.params.total)}</Text>
          </View>
        </View>
